...
\emph{BXI} pour "Bull eXascale Interconnect" est un type de réseau d'interconnexion (réseau haute performance) développé par \atos{}.
...
\begin{itemize}
  ...
  Lorsqu'il n'y a plus de calcul à effectuer, on repasse à une progression bloquante par un appel à \code{MPI_Wait}, sauf si la communication est déjà terminée.
