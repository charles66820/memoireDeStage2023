...
Pour l'envoi, que l'on peut voir sur la figure \ref{fig:sendUintrAsm}, on peut constater qu'entre la mesure et l'instruction d'envoi,
il y a seulement une lecture mémoire qui n'est pas très coûteuse.
Du côté de la réception, que l'on peut voir sur la figure \ref{fig:handlerUintrAsm},
...
On peut voir la déclaration d'un handler avec la mesure du temps sur la figure \ref{fig:unitrHandler}.
\begin{figure}[H]
